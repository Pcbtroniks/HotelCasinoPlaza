<section>
    ...
    <div class="px-8 py-[5.5rem] flex flex-wrap max-w-7xl mx-auto">
        <div class="w-1/2">
            ...
            <span class="border-b-4 border-main block w-72 my-2"></span>
            <p class="text-xl">
                En la ciudad de Guadalajara
            </p>
            <br>
            <p class="pr-8 text-justify text-dark-text">
        ...
        <!-- -->
        <div class="w-1/2 overflow-hidden card-shadow">
            <img class="w-full bg-cover object-cover scale-150" src="{{ asset('assets/img/about.jpg') }}" alt="About us Image">
        </div>
    </div>
