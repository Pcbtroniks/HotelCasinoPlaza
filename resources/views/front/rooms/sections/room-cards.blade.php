            ...
            <div class="max-w-screen-2xl mx-auto">
                ...
                <div class="card-shadow flex flex-col lg:flex-row xl:max-h-80 xl:h-80 max-w-[1253px] lg:mx-auto my-8">
                    ...
                    <div class="h-52 lg:h-full min-h-5 basis-1/3 lg:overflow-hidden">
                        <picture>
                            <img class="h-full w-full object-cover lg:h-96 xl:h-80" src="{{ asset('assets/img/rooms/ejecutiva.jpg') }}" alt="Habitacion ejecutiva">
                        </picture>
                    </div>
                ...
                <div class="card-shadow flex flex-col lg:flex-row xl:max-h-80 xl:h-80 max-w-[1253px] lg:mx-auto my-8">
                    ...
                    <div class="p-4 sm:p-6 flex flex-col basis-2/3 xl:h-80">
                        ...
                        <div>
                            ...
                            <p class="text-sm">
                                Nuestra habitación Doble cuenta con dos camas matrimoniales para 2, 3 o hasta 4 personas, TV por cable, aire acondicionado, calefacción, cerradura e iluminación electrónia, caja de seguridad, secadora de cabello, teléfono, mesa de trabajo individual, internet inalámbrico.
                            </p>
